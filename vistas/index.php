...
<body>
    <header>WALMART</header>
    <section>
    <table border="0" align="center">
    	<tr>             <td><input type="date" id="bd-desde"/></td>
            <td>Hasta&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="date" id="bd-hasta"/></td>
            <td width="100"><button id="filtroLocal" class="btn btn-primary" onclick="filtrarLocal()">Buscar</button></td>
